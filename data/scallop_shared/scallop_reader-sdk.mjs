...
async function main() {
  ...
  try {
    ...
    // Silently handle - rewards may not be available
  }
  ...
  try {
    ...
    // Silently handle - stake rewards may not be available
  }
  ...
  console.error(`SCALLOP SDK CALL COMPLETED IN ${elapsedSeconds} seconds`);
}
