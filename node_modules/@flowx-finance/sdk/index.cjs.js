...
var utils$1 = require('@mysten/sui.js/utils');
...
class ObjectId {
    constructor(objectId) {
        this.id = utils.normalizeSuiObjectId(objectId);
    }
}
...
function compare(symbolX, symbolY) {
    let i = 0;
    (symbolX = utils$1.normalizeStructTag(symbolX)),
        (symbolY = utils$1.normalizeStructTag(symbolY));
...
class Coin {
    constructor(coinType, decimals, symbol, name, description, iconUrl, derivedPriceInUSD, derivedSUI, isVerified) {
        utils.parseStructTag(coinType);
        invariant(!decimals ||
            (decimals >= 0 && decimals < 255 && Number.isInteger(decimals)), 'DECIMALS');
        this.coinType = utils.normalizeStructTag(coinType);
    ...
    take(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const totalBalance = ownedCoins.reduce((memo, coin) => memo.add(new BN.BN(coin.balance)), ZERO);
            invariant(totalBalance.gte(new BN.BN(amount.toString())), 'IF');
            if (this.coinType === utils.normalizeStructTag(utils.SUI_TYPE_ARG) && !isDevInspect) {
...
const toFixedRounding = {
    [exports.Rounding.ROUND_DOWN]: BigNumber.ROUND_DOWN,
    [exports.Rounding.ROUND_HALF_UP]: BigNumber.ROUND_HALF_UP,
    [exports.Rounding.ROUND_UP]: BigNumber.ROUND_UP,
};
class Fraction {
    ...
    toFixed(decimalPlaces, format = { groupSeparator: '', decimalSeparator: '.' }, rounding = exports.Rounding.ROUND_HALF_UP) {
...
class Price extends Fraction {
    ...
    constructor(...args) {
        ...
        this.scalar = new Fraction(new BN.BN(10).pow(new BN.BN(baseCoin.decimals)), new BN.BN(10).pow(new BN.BN(quoteCoin.decimals)));
    }
    /**
...
class TxBuilder {
    constructor(network) {
        ...
        this._tx = new transactions.Transaction();
    }
    ...
    get _client() {
        var _a;
        return ((_a = TxBuilder._client) !== null && _a !== void 0 ? _a : new client.SuiClient({ url: client.getFullnodeUrl(this.network) }));
    }
    clone() {
    ...
    createU64Option(value) {
        ...
        return tx.moveCall({
            ...
            function: !_.isNil(value) ? 'some' : 'none',
            typeArguments: ['u64'],
            arguments: !_.isNil(value)
...
class CoinAmount extends Fraction {
    ...
    toFixed(decimalPlaces = this.coin.decimals, format = { groupSeparator: '', decimalSeparator: '.' }, rounding = exports.Rounding.ROUND_DOWN) {
...
const multiGetObjects = (client, objectIds, options) => __awaiter(void 0, void 0, void 0, function* () {
    const batches = _.chunk(objectIds, MAX_OBJECTS_PER_QUERY);
...
function shortedCoinType(type) {
    const { address, module, name, typeParams } = typeof type === 'string' ? utils.parseStructTag(type) : type;
...
class GraphqlProvider {
    constructor(network = 'mainnet', config) {
        this.client = new graphqlRequest.GraphQLClient(CONFIGS$5[network].graphql.baseURI, config);
    }
}

const queryCoins = graphqlRequest.gql `
  query QueryCoins(
    $size: Int
    $page: Int
    $isVerified: Boolean
...
`;
const multiGetCoins = graphqlRequest.gql `
...
class CoinProvider {
    ...
    multiGetPrices(coinTypes_1) {
        return __awaiter(this, arguments, void 0, function* (coinTypes, refreshCache = false) {
            ...
            return coinTypes.map((coinType) => { var _a; return (_a = mappingPrice[utils.normalizeStructTag(coinType)]) !== null && _a !== void 0 ? _a : 0; });
        });
    }
}
...
class SuiBatchClient extends client.SuiClient {
    constructor(options) {
        super(options);
    ...
    getObject(input) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const inflightRequest = {
                request: utils.normalizeSuiObjectId(input.id),
                resolve: null,
                reject: null,
            };
            ...
            if (!__classPrivateFieldGet(this, _SuiBatchClient_pendingAggregator, "f")) {
                ...
                __classPrivateFieldSet(this, _SuiBatchClient_pendingAggregator, setTimeout(() => __awaiter(this, void 0, void 0, function* () {
                    ...
                    const batches = _.chunk((_a = __classPrivateFieldGet(this, _SuiBatchClient_queue, "f")) === null || _a === void 0 ? void 0 : _a.slice(), MAX_OBJECTS_PER_QUERY);
...
})(exports.CommissionType || (exports.CommissionType = {}));
const BPS$2 = new BN.BN(1000000);
const CONFIGS$5 = {
    mainnet: {
...
class SuiPriceServiceConnection {
    ...
    getPriceFeedsUpdateData(priceIds) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return latestVaas.map((latestVaa) => require$$0.Buffer.from(latestVaa, encoding));
        });
    }
}
            ...
            for (const vaa of vaas) {
                const [verifiedVaa] = tx.moveCall({
                    ...
                    arguments: [
                        ...
                        tx.pure(bcs.bcs.vector(bcs.bcs.u8()).serialize(vaa)),
                        tx.object(utils.SUI_CLOCK_OBJECT_ID),
                    ],
                });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            [priceUpdatesHotPotato] = tx.moveCall({
                ...
                arguments: [
                    ...
                    tx.pure(bcs.bcs.vector(bcs.bcs.u8()).serialize(updates[0])),
                    verifiedVaas[0],
                    tx.object(utils.SUI_CLOCK_OBJECT_ID),
                ],
            });
            ...
            if (!this.priceFeedObjectIdCache.has(normalizedFeedId)) {
                ...
                const result = yield this.provider.getDynamicFieldObject({
                    ...
                    name: {
                        ...
                        value: {
                            bytes: Array.from(require$$0.Buffer.from(normalizedFeedId, 'hex')),
                        },
                    },
                });
...
class PythHelper {
    ...
    updatePythPriceFeedsIfNecessary(routes, tx) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const uniquePriceIds = _.uniq(pythOracles.map((oracle) => oracle.priceId));
...
class Trade {
    constructor(options) {
        this._swap = (coinIn, pythMap) => (tx) => {
            ...
            if (!!this.commission &&
                ...
                const commissionType = this.commission.type === exports.CommissionType.PERCENTAGE
                    ? tx.moveCall({
    ...
    swap(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (!coinIn) {
                invariant(this.sender, 'SENDER');
                coinIn = transactions.coinWithBalance({
                    balance: BigInt(this.amountIn.toString()),
                    type: this.input.coinType,
                    useGasCoin: this.input.coinType === utils.normalizeStructTag(utils.SUI_TYPE_ARG),
                })(tx);
            }
            const pythHelper = PythHelper.getInstance({
                client: params.client,
...
class TradeBuilder {
    ...
    constructor(network, routes) {
        ...
        this._routes = routes;
        this._amountIn = sumBn$1(routes.map((route) => new BN.BN(route.amountIn)));
        this._amountOut = sumBn$1(routes.map((route) => new BN.BN(route.amountOut)));
        this._slippage = 0;
    ...
    build() {
        ...
        invariant(new BN.BN(this._amountIn).gt(ZERO), 'AMOUNT_IN');
        invariant(new BN.BN(this._amountOut).gt(ZERO), 'AMOUNT_OUT');
        invariant(new BN.BN(this._slippage).lte(BPS$2), 'SLIPPAGE');
        invariant((!this._sender || utils.isValidSuiAddress(this._sender)) &&
            (!this._recipient || utils.isValidSuiAddress(this._recipient)), 'ADDRESSEES');
        const amountIn = new BN.BN(this._amountIn).add(((_a = this._commission) === null || _a === void 0 ? void 0 : _a.coin.equals(this._routes[0].input))
...
class MultiTradesBuilder {
    ...
    build() {
        ...
        this._routeGroups.map((routes, index) => {
            var _a;
            const amountIn = sumBn$1(routes.map((r) => new BN.BN(r.amountIn)));
            const amountOut = sumBn$1(routes.map((r) => new BN.BN(r.amountOut)));
            const commission = (_a = this._commissions) === null || _a === void 0 ? void 0 : _a[index];
            invariant(new BN.BN(amountIn).gt(ZERO), 'AMOUNT_IN');
            invariant(new BN.BN(amountOut).gt(ZERO), 'AMOUNT_OUT');
            invariant(new BN.BN(this._slippage).lte(BPS$2), 'SLIPPAGE');
            if (commission) {
                invariant(routes[0].input.equals(commission.coin) ||
                    routes[0].output.equals(commission.coin), 'INVALID_COMMISSION');
            }
            const totalAmountIn = new BN.BN(amountIn).add((commission === null || commission === void 0 ? void 0 : commission.coin.equals(routes[0].input))
...
class Commission {
    constructor(partner, coin, type, value, directTransfer = false) {
        invariant(utils.isValidSuiAddress(partner), 'PARTNER');
        invariant(type === exports.CommissionType.FLAT ||
            (type === exports.CommissionType.PERCENTAGE && value < BPS$2), 'COMMISSION');
    ...
    computeCommissionAmount(amountInOrAmountOut, trade) {
        switch (this.type) {
            case exports.CommissionType.FLAT:
                return new BN.BN(this.value);
            case exports.CommissionType.PERCENTAGE:
                return this.coin.equals(trade.coinIn)
                    ? new BN.BN(amountInOrAmountOut)
                        .mul(new BN.BN(this.value))
                        .div(BPS$2.sub(new BN.BN(this.value)))
                    : new BN.BN(amountInOrAmountOut).mul(new BN.BN(this.value)).div(BPS$2);
            default:
                return ZERO;
        }
    }
...
function sqrtPriceX64ToPrice(baseCoin, quoteCoin, sqrtPriceX64) {
    const ratioX128 = new BN.BN(sqrtPriceX64).mul(new BN.BN(sqrtPriceX64));
...
class TickList {
    ...
    static validateList(ticks, tickSpacing) {
        ...
        invariant(ticks.reduce((accumulator, { liquidityNet }) => accumulator.add(new BN.BN(liquidityNet)), ZERO), 'ZERO_NET');
...
class AftermathSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.AFTERMATH;
    }
}
...
class DeepbookSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.DEEPBOOK;
    }
}
...
class FlowxV2Swap extends Swap {
    ...
    protocol() {
        return exports.Protocol.FLOWX_V2;
    }
}
...
class FlowxV3Swap extends Swap {
    ...
    protocol() {
        return exports.Protocol.FLOWX_V3;
    }
}
...
class KriyaDexSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.KRIYA_DEX;
    }
}
...
class TurbosSwap extends Swap {
    constructor(options) {
        ...
        this.swap = (routeObject, slippage) => (tx) => {
            ...
            const [, , swapFeeType] = utils.parseStructTag(this.poolStructTag).typeParams;
            tx.moveCall({
                target: `${wrappedRouterPackageId}::swap_router::${this.xForY ? 'swap_exact_x_to_y' : 'swap_exact_y_to_x'}`,
                typeArguments: [coinX, coinY, utils.normalizeStructTag(swapFeeType)],
                arguments: [
                    routeObject,
                    tx.object(this.pool.id),
                    tx.pure.u128(this.xForY
    ...
    protocol() {
        return exports.Protocol.TURBOS_FIANCE;
    }
}
...
class KriyaV3Swap extends Swap {
    ...
    protocol() {
        return exports.Protocol.KRIYA_V3;
    }
}
...
class BluemoveSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.BLUEMOVE;
    }
}
...
class DeepbookV3Swap extends Swap {
    ...
    protocol() {
        return exports.Protocol.DEEPBOOK_V3;
    }
}
...
class BluefinSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.BLUEFIN;
    }
}
...
class FlowxPmmSwap extends Swap {
        ...
        this.swap = (routeObject, slippage) => (tx) => {
            ...
            tx.moveCall({
                ...
                arguments: [
                    ...
                    quote,
                    tx.pure(bcs.bcs
                        .vector(bcs.bcs.vector(bcs.bcs.u8()))
                        .serialize(this.signatures.map((item) => bcs.bcs.bytes(item.replace('0x', '').length / 2).fromHex(item)))),
                    tx.object(utils.SUI_CLOCK_OBJECT_ID),
                ],
            });
        };
    ...
    protocol() {
        return exports.Protocol.FLOWX_PMM;
    }
}
...
class BlueMoveFunSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.BLUEMOVE_FUN;
    }
}
...
class HopFunSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.HOP_FUN;
    }
}
...
class SevenKFunSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.SEVEN_K_FUN;
    }
}
...
class TurbosFunSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.TURBOS_FUN;
    }
}
...
class HaedalPMMSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.HAEDAL_PMM;
    }
}
...
class HaedalSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.HAEDAL;
    }
}
...
class SpringSuiSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.SPRING_SUI;
    }
}
...
class AlphaFiSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.ALPHA_FI;
    }
}
...
class VoloLsdSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.VOLO_LSD;
    }
}
...
class AftermathLsdSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.AFTERMATH_LSD;
    }
}
...
class SteammSwap extends Swap {
    constructor(options) {
        ...
        const bankXTypeParams = utils.parseStructTag(options.bankXStructTag).typeParams;
        const bankYTypeParams = utils.parseStructTag(options.bankYStructTag).typeParams;
        const poolTypeParams = utils.parseStructTag(options.poolStructTag).typeParams;
        this.bankXInfo = {
            bankId: options.bankX,
            lendingMarketId: options.lendingMarketX,
            nativeCoinType: utils.normalizeStructTag(bankXTypeParams[1]),
            bTokenType: utils.normalizeStructTag(bankXTypeParams[2]),
            lendingMarketType: utils.normalizeStructTag(bankXTypeParams[0]),
        };
        this.bankYInfo = {
            bankId: options.bankY,
            lendingMarketId: options.lendingMarketY,
            nativeCoinType: utils.normalizeStructTag(bankYTypeParams[1]),
            bTokenType: utils.normalizeStructTag(bankYTypeParams[2]),
            lendingMarketType: utils.normalizeStructTag(bankYTypeParams[0]),
        };
        this.poolInfo = {
            poolId: this.pool.id,
            lpTokenType: utils.normalizeStructTag(poolTypeParams[poolTypeParams.length - 1]),
        };
        this._handlers = {
    ...
    protocol() {
        return exports.Protocol.STEAMM;
    }
}
...
class MetastableSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.METASTABLE;
    }
}
...
class MagmaFinanceSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.MAGMA_FINANCE;
    }
}
...
class MomentumFinanceSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.MOMENTUM_FINANCE;
    }
}
...
class FullSailSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.FULL_SAIL;
    }
}
...
class SevenKV1DexSwap extends Swap {
    constructor(options) {
        ...
        this.swap = (routeObject, _, pythMap) => (tx) => {
            ...
            const poolTypeArgs = utils.parseStructTag(this.poolStructTag).typeParams.map(utils.normalizeStructTag);
            tx.moveCall({
                target: `${wrappedRouterPackageId}::swap_router::${this.xForY ? 'swap_exact_x_to_y' : 'swap_exact_y_to_x'}`,
    ...
    protocol() {
        return exports.Protocol.SEVENK_V1;
    }
}
...
class IpxTideSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.IPX_TIDE;
    }
}
...
class TradeportSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.TRADEPORT;
    }
}
...
class DipCoinDexSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.DIPCOIN;
    }
}
...
class CetusDlmmSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.CETUS_DLMM;
    }
}
...
class FerraClmmSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.FERRA_CLMM;
    }
}
...
class FerraDlmmSwap extends Swap {
        ...
        this.swap = (routeObject) => (tx) => {
            ...
            tx.moveCall({
                ...
                arguments: [
                    ...
                    tx.object(globalConfigObjectId),
                    tx.object(this.pool.id),
                    tx.object(utils$1.SUI_CLOCK_OBJECT_ID),
                ],
            });
        };
        this.xForY = options.xForY;
    ...
    protocol() {
        return exports.Protocol.FERRA_DLMM;
    }
}
...
class MagmaAlmmSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.MAGMA_ALMM;
    }
}
...
class SuiRewardsMeSwap extends Swap {
    ...
    protocol() {
        return exports.Protocol.SUI_REWARDS;
    }
}
...
class AggregatorQuoter {
    ...
    buildPath(path, protocolConfig) {
        ...
        switch (path.source) {
            case exports.Protocol.FLOWX_V2:
            ...
            case exports.Protocol.FLOWX_V3: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_a = extra.minSqrtPriceHasLiquidity) === null || _a === void 0 ? void 0 : _a.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_b = extra.maxSqrtPriceHasLiquidity) === null || _b === void 0 ? void 0 : _b.toString()) ||
            ...
            case exports.Protocol.AFTERMATH: {
                const extra = path.extra;
            ...
            case exports.Protocol.CETUS: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_d = extra.minSqrtPriceHasLiquidity) === null || _d === void 0 ? void 0 : _d.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_e = extra.maxSqrtPriceHasLiquidity) === null || _e === void 0 ? void 0 : _e.toString()) ||
                        ClmmTickMath.MAX_SQRT_RATIO),
                ];
            ...
            case exports.Protocol.DEEPBOOK: {
                const extra = path.extra;
            ...
            case exports.Protocol.KRIYA_DEX:
            ...
            case exports.Protocol.TURBOS_FIANCE: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_g = extra.minSqrtPriceHasLiquidity) === null || _g === void 0 ? void 0 : _g.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_h = extra.maxSqrtPriceHasLiquidity) === null || _h === void 0 ? void 0 : _h.toString()) ||
                        ClmmTickMath.MAX_SQRT_RATIO),
                ];
            ...
            case exports.Protocol.KRIYA_V3: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_k = extra.minSqrtPriceHasLiquidity) === null || _k === void 0 ? void 0 : _k.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_l = extra.maxSqrtPriceHasLiquidity) === null || _l === void 0 ? void 0 : _l.toString()) ||
                        ClmmTickMath.MAX_SQRT_RATIO),
                ];
            ...
            case exports.Protocol.DEEPBOOK_V3: {
                const extra = path.extra;
            ...
            case exports.Protocol.BLUEMOVE:
            ...
            case exports.Protocol.BLUEFIN: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_o = extra.minSqrtPriceHasLiquidity) === null || _o === void 0 ? void 0 : _o.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_p = extra.maxSqrtPriceHasLiquidity) === null || _p === void 0 ? void 0 : _p.toString()) ||
                        ClmmTickMath.MAX_SQRT_RATIO),
                ];
            ...
            case exports.Protocol.FLOWX_PMM: {
                const extra = path.extra;
            ...
            case exports.Protocol.BLUEMOVE_FUN:
            ...
            case exports.Protocol.SEVEN_K_FUN:
            ...
            case exports.Protocol.TURBOS_FUN:
            ...
            case exports.Protocol.HAEDAL_PMM: {
                const extra = path.extra;
            ...
            case exports.Protocol.SPRING_SUI:
            ...
            case exports.Protocol.ALPHA_FI:
            ...
            case exports.Protocol.VOLO_LSD:
            ...
            case exports.Protocol.AFTERMATH_LSD:
            ...
            case exports.Protocol.METASTABLE: {
                const extra = path.extra;
            ...
            case exports.Protocol.MAGMA_FINANCE: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_u = extra.minSqrtPriceHasLiquidity) === null || _u === void 0 ? void 0 : _u.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_v = extra.maxSqrtPriceHasLiquidity) === null || _v === void 0 ? void 0 : _v.toString()) ||
                        ClmmTickMath.MAX_SQRT_RATIO),
                ];
            ...
            case exports.Protocol.MOMENTUM_FINANCE: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_x = extra.minSqrtPriceHasLiquidity) === null || _x === void 0 ? void 0 : _x.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_y = extra.maxSqrtPriceHasLiquidity) === null || _y === void 0 ? void 0 : _y.toString()) ||
                        ClmmTickMath.MAX_SQRT_RATIO),
                ];
            ...
            case exports.Protocol.FULL_SAIL: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_0 = extra.minSqrtPriceHasLiquidity) === null || _0 === void 0 ? void 0 : _0.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_1 = extra.maxSqrtPriceHasLiquidity) === null || _1 === void 0 ? void 0 : _1.toString()) ||
                        ClmmTickMath.MAX_SQRT_RATIO),
                ];
            ...
            case exports.Protocol.SEVENK_V1: {
                const extra = path.extra;
            ...
            case exports.Protocol.IPX_TIDE: {
                const extra = path.extra;
            ...
            case exports.Protocol.TRADEPORT: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_3 = extra.minSqrtPriceHasLiquidity) === null || _3 === void 0 ? void 0 : _3.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_4 = extra.maxSqrtPriceHasLiquidity) === null || _4 === void 0 ? void 0 : _4.toString()) ||
                        ClmmTickMath.MAX_SQRT_RATIO),
                ];
            ...
            case exports.Protocol.FERRA_DLMM: {
            ...
            case exports.Protocol.FERRA_CLMM: {
                const extra = path.extra;
                const [minSqrtPriceX64HasLiquidity, maxSqrtPriceX64HasLiquidity] = [
                    new BN.BN(((_6 = extra.minSqrtPriceHasLiquidity) === null || _6 === void 0 ? void 0 : _6.toString()) ||
                        ClmmTickMath.MIN_SQRT_RATIO),
                    new BN.BN(((_7 = extra.maxSqrtPriceHasLiquidity) === null || _7 === void 0 ? void 0 : _7.toString()) ||
                        ClmmTickMath.MAX_SQRT_RATIO),
                ];
            ...
            case exports.Protocol.MAGMA_ALMM: {
            ...
            case exports.Protocol.SUI_REWARDS:
            ...
            case exports.Protocol.CETUS_DLMM: {
    ...
    getRoutes(params) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const sources = params.includeSources || Object.values(exports.Protocol);
            const excludeSources = (_a = params.excludeSources) !== null && _a !== void 0 ? _a : [exports.Protocol.FLOWX_PMM];
            const queryParams = {
                apiKey: this.apiKey,
                ...
                excludePools: (_b = params.excludePools) === null || _b === void 0 ? void 0 : _b.map((pool) => utils.normalizeSuiObjectId(pool)).join(','),
            ...
            if (params.commission &&
                ...
                if (params.commission.type === exports.CommissionType.PERCENTAGE) {
                    queryParams['feeInBps'] = new BN.BN(params.commission.value)
                        .mul(new BN.BN(AGGREGATOR_BPS))
                        .div(BPS$2)
                        .toString();
                }
                else {
    ...
    getMultipleRoutes(params, externalSignal) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const requestBody = params.map((p) => {
                ...
                const r = {
                    tokenIn: utils.normalizeStructTag(p.tokenIn),
                    tokenOut: utils.normalizeStructTag(p.tokenOut),
                    amountIn: p.amountIn,
                    ...
                    excludePools: ((_c = p.excludePools) === null || _c === void 0 ? void 0 : _c.map((pool) => utils.normalizeSuiObjectId(pool)).join(',')) ||
                        '',
                ...
                if (p.commission &&
                    ...
                    if (p.commission.type === exports.CommissionType.PERCENTAGE) {
                        r['feeInBps'] = new BN.BN(p.commission.value)
                            .mul(new BN.BN(AGGREGATOR_BPS))
                            .div(BPS$2)
                            .toNumber();
                    }
...
class PartnerManager {
    constructor({ network, client: client$1 }) {
        this.mappingPartnerBalancesParentId = {};
        this.withdrawCommissions = ({ address, coins, recipient }) => (...args_1) => __awaiter(this, [...args_1], void 0, function* (tx = new transactions.Transaction()) {
        ...
        this.network = network;
        this.client =
            client$1 !== null && client$1 !== void 0 ? client$1 : new client.SuiClient({
                url: client.getFullnodeUrl(network),
            });
    }
        ...
        return __awaiter(this, arguments, void 0, function* ({ address, coins }) {
            ...
            if (isAll) {
                ...
                return dfObjects
                    ...
                    .map((df) => CoinAmount.fromRawAmount(new Coin(utils.normalizeStructTag(df.content.fields.name.fields.name)), df.content.fields.value));
            }
            else {
                ...
                return dfObjects
                    ...
                    .map((df) => CoinAmount.fromRawAmount(new Coin(utils.normalizeStructTag(df.data.content.fields.name.fields.name)), df.data.content.fields.value));
            }
        });
    }
}
...
const BPS = 10000;
const MINIMUM_LIQUIDITY = new BN.BN(1000);
...
const UID = bcs.bcs.fixedArray(32, bcs.bcs.u8()).transform({
    input: (id) => utils.fromHEX(id),
    output: (id) => utils.toHEX(Uint8Array.from(id)),
});
const CoinBcs = bcs.bcs.struct('Coin', {
    id: UID,
    value: bcs.bcs.u64(),
});
const CoinSupplyBcs = bcs.bcs.struct('CoinSupply', {
    value: bcs.bcs.u64(),
});

const PoolMetadataBcs = bcs.bcs.struct('PoolMetadata', {
    id: UID,
    reserveX: CoinBcs,
    reserveY: CoinBcs,
    kLast: bcs.bcs.u128(),
...
class AmmPositionManager extends TxBuilder {
    ...
    getUserPositions(owner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const batches = _.chunk(liquidityCoins, MAX_OBJECTS_PER_QUERY);
            const pools = (yield Promise.all(batches.map((batch) => this.poolManager.multiGetPools(batch.map((item) => {
                const { typeParams } = utils.parseStructTag(item.coinType);
                return {
                    coinX: new Coin(utils.normalizeStructTag(typeParams[0])),
                    coinY: new Coin(utils.normalizeStructTag(typeParams[1])),
                };
            }))))).flat();
    ...
    increaseLiquidity(position, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return this._tx.moveCall({
                ...
                arguments: [
                    this._tx.object(utils.SUI_CLOCK_OBJECT_ID),
    ...
    decreaseLiquidity(position, options) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const liquidityCoinToRemove = transactions.coinWithBalance({
...
const REWARD_PRECISION = new BN.BN(1000000);
...
class FaaSPoolManager extends TxBuilder {
    ...
    multiGetLiquidityPools(params) {
        return __awaiter(this, void 0, void 0, function* () {
            const poolIds = _.uniq(params.map((param) => AmmPool.getPoolIdentifier(param.coinX, param.coinY)));
            const cached = sdkCache.mget(poolIds);
            const missingKeys = poolIds.filter((poolId) => !cached[poolId]);
            const batches = _.chunk(missingKeys, MAX_OBJECTS_PER_QUERY);
            const missingPools = (yield Promise.all(batches.map((batch) => limit(() => this.liquidityPoolManager.multiGetPools(batch.map((it) => {
                ...
                return {
                    coinX: new Coin(utils.normalizeStructTag(coinX)),
                    coinY: new Coin(utils.normalizeStructTag(coinY)),
                };
            })))))).flat();
    ...
    getPool(poolIndex) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const { typeParams } = utils.parseStructTag((_b = (_a = poolDf.data) === null || _a === void 0 ? void 0 : _a.content) === null || _b === void 0 ? void 0 : _b['fields'].value.type);
            const liquidityPool = yield this.getLiquidityPool(new Coin(utils.normalizeStructTag(typeParams[0])), new Coin(utils.normalizeStructTag(typeParams[1])));
            ...
            return new FaaSPool({
                ...
                poolIndex: poolIndex,
                tokenRewardType: utils.normalizeStructTag(utils.parseStructTag(reward_token_custodian.type).typeParams[0]),
                flxTokenType: utils.normalizeStructTag(utils.parseStructTag(flx_custodian.type).typeParams[0]),
    ...
    multiGetPools(poolIndexes) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return Promise.all(_.uniq(poolIndexes).map((poolIndex) => limit(() => this.getPool(poolIndex))));
        });
    }
    getAllPools() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const multiGetLiquidityPoolParams = poolObjects.map((poolObject) => {
                var _a;
                const { typeParams } = utils.parseStructTag((_a = poolObject === null || poolObject === void 0 ? void 0 : poolObject.content) === null || _a === void 0 ? void 0 : _a['fields'].value.type);
                const [coinX, coinY] = [
                    new Coin(utils.normalizeStructTag(typeParams[0])),
                    new Coin(utils.normalizeStructTag(typeParams[1])),
                ];
                return {
                    coinX,
                    coinY,
            ...
            const pools = poolObjects.map((poolObject) => {
                ...
                const { typeParams } = utils.parseStructTag((_b = poolObject === null || poolObject === void 0 ? void 0 : poolObject.content) === null || _b === void 0 ? void 0 : _b['fields'].value.type);
                return new FaaSPool({
                    objectId: id.id,
                    ...
                    creator: creator,
                    isEmergency: is_emergency,
                    liquidityPool: mappingLiquidityPools[AmmPool.getPoolIdentifier(new Coin(utils.normalizeStructTag(typeParams[0])), new Coin(utils.normalizeStructTag(typeParams[1])))],
                    totalLiquidityCoinStaked: lp_custodian.fields.reserve,
                });
            });
    ...
    getUserPositions(owner) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const validPositions = ownedPositionObjects
                ...
                .filter((item) => !new BN.BN(item.amount).isZero());
...
class TickOnchainDataProvider {
    constructor({ network, tickManagerId, }) {
        ...
        this.client = new client.SuiClient({
            url: client.getFullnodeUrl(network),
        });
    }
    getTick(index) {
...
class ClmmPositionManager extends TxBuilder {
    ...
    increaseLiquidity(position, options) {
        ...
        const [coinXIn, coinYIn] = [
            (_a = options.coinXIn) !== null && _a !== void 0 ? _a : transactions.coinWithBalance({
                type: position.amountX.coin.coinType,
                balance: BigInt(amountXDesired.toString()),
                useGasCoin: utils.normalizeStructTag(utils.SUI_TYPE_ARG) ===
                    utils.normalizeStructTag(position.amountX.coin.coinType),
            })(this._tx),
            (_b = options.coinYIn) !== null && _b !== void 0 ? _b : transactions.coinWithBalance({
                type: position.amountY.coin.coinType,
                balance: BigInt(amountYDesired.toString()),
                useGasCoin: utils.normalizeStructTag(utils.SUI_TYPE_ARG) ===
                    utils.normalizeStructTag(position.amountY.coin.coinType),
            })(this._tx),
        ];
        this._tx.moveCall({
    ...
    collect(position, options) {
        invariant(!options.recipient || utils.isValidSuiAddress(options.recipient), 'RECIPIENT');
    ...
    getPositionReward(positions_1) {
        return __awaiter(this, arguments, void 0, function* (positions, maxQuery = 10) {
            ...
            const batches = _.chunk(positions, maxQuery);
            for (const positions of batches) {
                this.tx(new transactions.Transaction());
    ...
    getPoolDetail(poolId) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            const poolCoins = yield Promise.all([
                fetchCoin(utils.normalizeStructTag(rawData.coin_type_x.fields.name))(this._client),
                fetchCoin(utils.normalizeStructTag(rawData.coin_type_y.fields.name))(this._client),
            ]);
    ...
    getPoolDetails(poolIds) {
        return __awaiter(this, void 0, void 0, function* () {
            return (yield this.getMultipleIds(_.uniq(poolIds))).map((pool) => {
                const poolCoins = [
                    new Coin(utils.normalizeStructTag(pool.data.content.fields.coin_type_x.fields.name)),
                    new Coin(utils.normalizeStructTag(pool.data.content.fields.coin_type_y.fields.name)),
                ];
...
class Rebalancer {
    constructor(options) {
        ...
        this.rebalance = (position, tickLower, tickUpper, options) => (tx) => __awaiter(this, void 0, void 0, function* () {
            var _a;
            const client$1 = (options === null || options === void 0 ? void 0 : options.client) ||
                new client.SuiClient({
                    url: client.getFullnodeUrl(this.network),
                });
            ...
            if (remainingX.gt(new BN(minZapAmounts.amountX))) {
                const commission = (options === null || options === void 0 ? void 0 : options.commission) ? new Commission(options.commission.address, new Coin(coinYType), exports.CommissionType.PERCENTAGE, options.commission.fee, false) : undefined;
                ...
                const commission = (options === null || options === void 0 ? void 0 : options.commission) ? new Commission(options.commission.address, new Coin(coinXType), exports.CommissionType.PERCENTAGE, options.commission.fee, false) : undefined;
                const zapAmount = yield ZapCalculator.zapAmount({
                    pool: position.pool,
                    tickLower,
                    tickUpper,
...
const TypeNameBCS$1 = bcs.bcs.struct('TypeName', {
    name: bcs.bcs.String,
});
const OrderBCS = bcs.bcs.struct('Order', {
    order_id: bcs.bcs.U64,
    client_order_id: bcs.bcs.U64,
    maker_asset: TypeNameBCS$1,
    taker_asset: TypeNameBCS$1,
    maker: bcs.bcs.Address,
    recipient: bcs.bcs.Address,
    allowed_taker: bcs.bcs.option(bcs.bcs.Address),
    making_amount: bcs.bcs.U64,
    remaining_amount: bcs.bcs.U64,
    taking_amount: bcs.bcs.U64,
    expires_timestamp: bcs.bcs.U64,
    allowed_partial_fills: bcs.bcs.Bool,
});
const QueryResultBCS$1 = bcs.bcs.struct('QueryResult', {
    orders: bcs.bcs.vector(OrderBCS),
    cursor: bcs.bcs.option(bcs.bcs.U64),
    total: bcs.bcs.U64,
});
...
exports.SubscriptionCycle = void 0;
...
})(exports.SubscriptionCycle || (exports.SubscriptionCycle = {}));
...
const calculateSubscriptionInterval = (cycle, quantityBig) => {
    ...
    switch (cycle) {
        case exports.SubscriptionCycle.MINUTE:
            return quantity * ONE_MINUTE;
        case exports.SubscriptionCycle.HOUR:
            return quantity * ONE_HOUR;
        case exports.SubscriptionCycle.DAY:
            return quantity * ONE_DAY;
        case exports.SubscriptionCycle.WEEK:
            return quantity * ONE_WEEK;
        case exports.SubscriptionCycle.MONTH:
...
class PlanBuilder {
    ...
    build() {
        ...
        invariant(_.isNil(this.info.owner) || utils.isValidSuiAddress(this.info.owner), 'invalid owner');
        invariant(_.isNil(this.info.receiver) || utils.isValidSuiAddress(this.info.receiver), 'invalid receiver');
        utils.parseStructTag(this.info.sourceAsset);
        utils.parseStructTag(this.info.targetAsset);
        return new Plan({
            ...
            status: (_d = this.info.status) !== null && _d !== void 0 ? _d : exports.PlanStatus.ONGOING,
        });
    }
}

const TypeNameBCS = bcs.bcs.struct('TypeName', {
    name: bcs.bcs.String,
});
const PlanBCS = bcs.bcs.struct('Plan', {
    plan_id: bcs.bcs.U64,
    subscription_amount: bcs.bcs.U64,
    subscription_interval: bcs.bcs.U64,
    next_execution_time: bcs.bcs.U64,
    execution_count: bcs.bcs.U64,
    execution_limit: bcs.bcs.U64,
    average_price: bcs.bcs.U64,
    total_purchased_amount: bcs.bcs.U64,
    creation_time: bcs.bcs.U64,
    owner: bcs.bcs.Address,
    receiver: bcs.bcs.Address,
    source_asset: TypeNameBCS,
    target_asset: TypeNameBCS,
    paused: bcs.bcs.Bool,
});
const QueryResultBCS = bcs.bcs.struct('QueryResult', {
    plans: bcs.bcs.vector(PlanBCS),
    cursor: bcs.bcs.option(bcs.bcs.U64),
    has_nex_page: bcs.bcs.Bool,
    total: bcs.bcs.U64,
});
...
class AutoInvest extends TxBuilder {
    ...
    planExists(planIds) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return ((_b = (_a = resp.results) === null || _a === void 0 ? void 0 : _a.map((result) => { var _a, _b, _c; return bcs.bcs.Bool.parse(new Uint8Array((_c = (_b = (_a = result.returnValues) === null || _a === void 0 ? void 0 : _a[0]) === null || _b === void 0 ? void 0 : _b[0]) !== null && _c !== void 0 ? _c : [])); })) !== null && _b !== void 0 ? _b : []);
        });
    }
    queryPlans(filters) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return {
                plans: queryResult.plans.map((plan) => new Plan({
                    ...
                    sourceAsset: utils.normalizeStructTag(plan.source_asset.name),
                    targetAsset: utils.normalizeStructTag(plan.target_asset.name),
                    creationTime: Number(plan.creation_time),
                    status: plan.paused ? exports.PlanStatus.PAUSED : exports.PlanStatus.ONGOING,
                })),
    ...
    getAccountBalance(coinType, account) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            return results
                ? bcs.bcs.U64.parse(new Uint8Array((_d = (_c = (_b = (_a = results[0]) === null || _a === void 0 ? void 0 : _a.returnValues) === null || _b === void 0 ? void 0 : _b[0]) === null || _c === void 0 ? void 0 : _c[0]) !== null && _d !== void 0 ? _d : []))
                : '0';
        });
    }
}
...
exports.AggregatorQuoter = AggregatorQuoter;
exports.AmmLiquidityMath = AmmLiquidityMath;
exports.AmmPool = AmmPool;
exports.AmmPoolManager = AmmPoolManager;
exports.AmmPosition = AmmPosition;
exports.AmmPositionManager = AmmPositionManager;
exports.AutoInvest = AutoInvest;
exports.BPS = BPS$2;
exports.BasePool = BasePool;
exports.Bridge = Bridge;
exports.CONFIGS = CONFIGS$5;
exports.ClmmLiquidityMath = ClmmLiquidityMath;
exports.ClmmPool = ClmmPool;
exports.ClmmPoolManager = ClmmPoolManager;
exports.ClmmPosition = ClmmPosition;
exports.ClmmPositionManager = ClmmPositionManager;
exports.ClmmSqrtPriceMath = ClmmSqrtPriceMath;
exports.ClmmTickMath = ClmmTickMath;
exports.Coin = Coin;
exports.CoinAmount = CoinAmount;
exports.CoinProvider = CoinProvider;
exports.Commission = Commission;
exports.CustomError = CustomError;
exports.DEADLINE_TIME_SECONDS = DEADLINE_TIME_SECONDS;
exports.DEFAULT_CACHE_EXPIRATION_TIME_SECONDS = DEFAULT_CACHE_EXPIRATION_TIME_SECONDS;
exports.DEFAULT_CONCURRENCY = DEFAULT_CONCURRENCY;
exports.DEFAULT_DECIMAL = DEFAULT_DECIMAL;
exports.FLOAT_SCALING = FLOAT_SCALING;
exports.FaaSPool = FaaSPool;
exports.FaaSPoolManager = FaaSPoolManager;
exports.FaaSPosition = FaaSPosition;
exports.FaaSPositionManager = FaaSPositionManager;
exports.FlowXPriceProvider = FlowXPriceProvider;
exports.Fraction = Fraction;
exports.GraphqlProvider = GraphqlProvider;
exports.LimitOrderBuilder = LimitOrderBuilder;
exports.MAPPING_INVESTMENT_OBJECT_ID = MAPPING_INVESTMENT_OBJECT_ID;
exports.MAPPING_PACKAGE_ID = MAPPING_PACKAGE_ID;
exports.MAX_OBJECTS_DEV_INSPECT_PER_QUERY = MAX_OBJECTS_DEV_INSPECT_PER_QUERY;
exports.MAX_OBJECTS_PER_QUERY = MAX_OBJECTS_PER_QUERY;
exports.MODULE_AUTO_INVEST = MODULE_AUTO_INVEST;
exports.MODULE_COMMISSION = MODULE_COMMISSION;
exports.MODULE_COMMISSION_TYPE = MODULE_COMMISSION_TYPE;
exports.MODULE_OPTION = MODULE_OPTION;
exports.MODULE_PLAN_QUERY = MODULE_PLAN_QUERY;
exports.MODULE_UNIVERSAL_ROUTER = MODULE_UNIVERSAL_ROUTER;
exports.MaxUint256 = MaxUint256;
exports.MaxUint64 = MaxUint64;
exports.MultiTradesBuilder = MultiTradesBuilder;
...
exports.OrderBCS = OrderBCS;
exports.PartnerManager = PartnerManager;
exports.Percent = Percent;
exports.PerpBonus = PerpBonus;
exports.Plan = Plan;
exports.PlanBuilder = PlanBuilder;
exports.Price = Price;
exports.PricePredict = PricePredict;
exports.PromiseAll = PromiseAll;
exports.Q128 = Q128;
exports.Q64 = Q64;
exports.QueryResultBCS = QueryResultBCS$1;
exports.Rebalancer = Rebalancer;
exports.Route = Route;
exports.STD_PACKAGE_ID = STD_PACKAGE_ID;
exports.SUI_PACKAGE_ID = SUI_PACKAGE_ID;
exports.SuiBatchClient = SuiBatchClient;
exports.Swap = Swap;
exports.Tick = Tick;
exports.TickLibrary = TickLibrary;
exports.TickList = TickList;
exports.TickListDataProvider = TickListDataProvider;
exports.TickOnchainDataProvider = TickOnchainDataProvider;
exports.Trade = Trade;
exports.TradeBuilder = TradeBuilder;
exports.TxBuilder = TxBuilder;
exports.TypeNameBCS = TypeNameBCS$1;
exports.ZERO = ZERO;
exports.ZapCalculator = ZapCalculator;
exports.bigNumberUtils = bigNumber;
exports.calculateExecutionPrice = calculateExecutionPrice;
exports.calculateSubscriptionInterval = calculateSubscriptionInterval;
exports.closestActiveRange = closestActiveRange;
exports.encodeSqrtRatioX64 = encodeSqrtRatioX64;
exports.fetchCoin = fetchCoin;
exports.getAllDynamicFields = getAllDynamicFields;
exports.getAllOwnedObjects = getAllOwnedObjects;
exports.getDeadlineAtTimestampMs = getDeadlineAtTimestampMs;
...
exports.shortedCoinType = shortedCoinType;
exports.sqrtBn = sqrtBn;
exports.sqrtPriceX64ToPrice = sqrtPriceX64ToPrice;
exports.standardShortCoinType = standardShortCoinType;
exports.sumBn = sumBn$1;
